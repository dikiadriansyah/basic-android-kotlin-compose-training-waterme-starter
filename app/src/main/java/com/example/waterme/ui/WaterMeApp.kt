...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.one_minute, ONE_MINUTE, TimeUnit.SECONDS, plantName),
        Reminder(R.string.two_minute, TWO_MINUTE, TimeUnit.SECONDS, plantName),
        Reminder(R.string.three_minute, THREE_MINUTE, TimeUnit.SECONDS, plantName),
